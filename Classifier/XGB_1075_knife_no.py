# -*- coding: utf-8 -*-
"""
Created on Sat Apr  6 21:52:57 2019
...
for train, test in loo.split(X): 
    ...
    hist=xgb_model.fit(X_train, y_train)
    y_predict_score=xgb_model.predict_proba(X_test) 
...
yscore_sum.to_csv('yscore_XGB_1075_knife_no.csv')
ytest_sum = pd.DataFrame(data=y_sparse)
ytest_sum.to_csv('ytest_XGB_1075_knife_no.csv')
fpr, tpr, _ = roc_curve(y_sparse[:,0], y_score[:,0])
auc_score=result[6]
lw=2
...
data_csv.to_csv('XGB_1075_knife_no.csv')
